...
def main():
    ...
    stat_prop_result_cv_test["Summary Test Results: (Passed/Failed) % "] =  stat_prop_result_cv_test["n_pass"].astype(str)+' / '+ stat_prop_result_cv_test["n_fail"].astype(str)+ ' ' + calc_test_percentage()
