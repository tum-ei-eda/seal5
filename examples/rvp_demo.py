...
DEST = os.environ.get("DEST", DEST_DIR + "/seal5_llvm_rvp").rstrip("/")

FILES = [
    # CoreDSL inputs
    EXAMPLES_DIR / "rvp" / "cdsl" / "RV32P.core_desc",
    # EXAMPLES_DIR / "rvp" / "cdsl" / "RVP.core_desc",
    # Test inputs
    # YAML inputs
...
run_seal5_flow(FILES, name="rvp", dest=DEST)
