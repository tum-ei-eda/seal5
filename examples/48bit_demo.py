...
LLVM_URL = os.environ.get("LLVM_URL", "https://gitlab.lrz.de/aemy/projects/scale4edge/llvm-project")
# LLVM_REF = os.environ.get("LLVM_REF", "LLVM_18.1.3_E48")
LLVM_REF = os.environ.get("LLVM_REF", "LLVM_18.1.3_E48_philippvk")
...
DEST = os.environ.get("DEST", DEST_DIR + "/seal5_llvm_48bit").rstrip("/")
NAME = os.environ.get("NAME", "48bit")
...
if PREPATCHED:
    if seal5_flow.repo is None or "seal5-48bit-stage0" not in seal5_flow.repo.tags:
