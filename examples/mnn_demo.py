...
DEST = os.environ.get("DEST", DEST_DIR + "/seal5_llvm_mnn").rstrip("/")
NAME = os.environ.get("NAME", "mnn")
...
if PREPATCHED:
    if seal5_flow.repo is None or "seal5-mnn-stage0" not in seal5_flow.repo.tags:
