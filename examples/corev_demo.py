...
seal5_flow = Seal5Flow("/tmp/seal5_llvm_corev", "corev")
...
if PREPATCHED:
    if seal5_flow.repo is None or "seal5-corev-stage0" not in seal5_flow.repo.tags:
...
seal5_flow.export("/tmp/seal5_llvm_corev.tar.gz", verbose=VERBOSE)
