...
DEST = os.environ.get("DEST", DEST_DIR + "/seal5_llvm_tumeda")
NAME = os.environ.get("NAME", "tumeda")
...
if PREPATCHED:
    if seal5_flow.repo is None or "seal5-tumeda-stage0" not in seal5_flow.repo.tags:
...
seal5_flow.initialize(
    ...
    clone_ref="seal5-tumeda-stage0" if PREPATCHED else "llvmorg-18.1.0-rc3",
