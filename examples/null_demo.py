...
#
"""Demo script for Seal5 Python API, building a toolchain without custom instructions."""
import os
...
# Load CoreDSL inputs
cdsl_files = [
#    EXAMPLES_DIR / "cdsl" / "rv_chacha20" / "chacha20_llvm.core_desc",
]
...
cfg_files = [
    ...
    EXAMPLES_DIR / "cfg" / "rv_chacha20/intrinsics.yml",
]
