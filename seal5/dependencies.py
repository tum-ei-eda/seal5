...
def pick_coredsl2llvm_ref(ref: str, llvm_version: LLVMVersion):
    if ref is not None:
        return ref
    ...
    # TODO: auto-lookup ref after clone?
    if major == 22:
        ref = "llvm-22.1.8"
    elif major == 21:
        ref = "llvm-21.1.7"
    ...
    assert ref is not None, f"Could not find a CoreDSL2LLVM ref for LLVM version {major}.{minor}.{patch}"
